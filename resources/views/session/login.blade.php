...
<head>
	<title>Mendoza Events - Login</title>
	@include('components.head')
	@include('layouts.login.login-css')
</head>

<body
	style="background-image: url('{{ asset('import/assets/img/wedding-background.jpg') }}'); background-repeat: no-repeat; background-size: cover;">

	<form class="form_container" method="post" action="{{ url('/login') }}">
		@csrf
		...
		<div class="input_container">
			...
			<input class="input_field" name="email" type="email" id="email" placeholder="Email" required>
		</div>
		<div class="input_container">
			...
			<input class="input_field" name="password" type="password" id="password" placeholder="Password" required>
		</div>
