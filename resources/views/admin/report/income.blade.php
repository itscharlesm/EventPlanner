...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active" id="reportsMenu">
        ...
        <div id="content">
            ...
            <button id="darkModeToggle" class="btn btn-sm btn-dark shadow-sm">
                <i class="fas fa-moon fa-sm text-white-50"></i> Dark Mode
            </button>
